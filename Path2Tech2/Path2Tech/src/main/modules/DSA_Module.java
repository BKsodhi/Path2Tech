...
public class DSA_Module {
    public static void start(String type, String username, Scanner sc) {
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    showCodingMenu(username, "dsa", sc);
                    break;
                case 2:
    ...
    private static void showCodingMenu(String username, String subject, Scanner sc) {
        ...
        while (true) {
            ...
            for (int i = 0; i < files.length; i++) {
                System.out.println((i + 1) + " Ques: " + files[i].getName());
            }
            ...
            if (choice >= 1 && choice <= files.length) {
                ...
                String questionName = files[choice - 1].getName().replace(".txt", "");
                ProgressDatabase.saveQuestionProgress(username, "dsa", questionName, true);
            } else {
    ...
    private static void showInterviewDifficultyMenu(String username, Scanner sc) {
        ...
        String filePath = "main/data/questions/dsa/interview/" + level + ".txt";
    ...
    private static void startMockTest(String username) {
        System.out.println("Starting mock test for " + username + "...");
        System.out.println("All the best with your mock test!");
    }
